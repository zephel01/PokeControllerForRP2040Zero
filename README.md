...
- **高信頼性・堅牢設計 (v1.3.5 強化)**:
  ...
  - **Activity LED (v1.3.5)**: 受信時に緑LEDが一瞬点滅し、通信状態を視覚的に確認できるようになりました。
...
2. **ファームウェアを書き込む**:
   - [Releases ページ](https://github.com/zephel01/PokeControllerForRP2040Zero/releases/tag/v1.3.5) から `PokeControllerForRP2040Zero_RP2040Zero_v1.3.5.uf2` をダウンロードします。
