...
- **高信頼性・堅牢設計 (v1.4.1 強化)**:
- **プロトコル統一 (v1.4.1)**: Pico版/Leonardo版と同じ16bitプロトコルに対応。
...
```
[ボタンデータ 16bit] [HAT] [LX] [LY] [RX] [RY]\n
```

| フィールド   | サイズ | 値            | 説明                        |
|------------|-------|---------------|---------------------------|
| ボタンデータ | 16bit | 0x0000-0xFFFF | ボタン状態のビットマップ        |
| HAT        | 8bit  | 0x00-0x08     | 十字キー方向                |
| LX         | 8bit  | 0x00-0xFF     | 左スティックX (0x80=中央)      |
| LY         | 8bit  | 0x00-0xFF     | 左スティックY (0x80=中央)      |
| RX         | 8bit  | 0x00-0xFF     | 右スティックX (0x80=中央)      |
| RY         | 8bit  | 0x00-0xFF     | 右スティックY (0x80=中央)      |
...
- **Aボタンのみ**: `0004 08 80 80 80 80`
- **A+Bボタン**: `0006 08 80 80 80 80`
- **上十字キー**: `0000 00 80 80 80 80`
- **左スティック右上**: `0000 08 FF 40 80 80`

> **注**: v1.4.1以降、Pico版/Leonardo版と同じ16bitプロトコルに統合されました。スティック更新フラグは不要になりました。
