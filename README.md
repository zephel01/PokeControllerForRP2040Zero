...
2. **ファームウェアを書き込む**:
   - [Releases ページ](https://github.com/zephel01/PokeControllerForRP2040Zero/releases/tag/v1.3.4) から `PokeControllerForRP2040Zero_RP2040Zero_v1.3.4.uf2` をダウンロードします。
...
### 接続構成とポートの違い (v1.3.3 〜 v1.3.4 以降)

v1.3.3 / v1.3.4 から、**USBケーブル 1本で「操作」と「デバッグ」の両方が可能** になりました。
